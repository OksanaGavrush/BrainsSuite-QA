...
class PostSyncUser(BaseEndpoint):
    ...
    def create_user_without_authorization(self, payload=None):
        ...
        with allure.step(f"Payload: {payload}"):
            self.response = requests.post(f'{self.base_url}/nextlogic/sync', json=payload)
    ...
    def no_create_user_already_exists(self,  payload=None):
        payload = payload if payload else PAYLOAD
        headers = {"Authorization-App": f"{self.auth_app}"}
        self.response = requests.post(f'{self.base_url}/nextlogic/sync', json=payload, headers=headers)
    ...
    def send_user_info_update(self, name, birthdate, gender):
        headers = {"Authorization-App": f"{self.auth_app}"}
        payload = {
            "nlPatientId": "ALICEx1",
            "gender": gender,
    ...
    def sending_request_without_gender(self):
        headers = {"Authorization-App": f"{self.auth_app}"}
        payload = {
            "nlPatientId": "ALICEx1",
            "birthdate": "1990-05-15",
    ...
    def gender_acceptance_validator(self, gender):
        headers = {"Authorization-App": f"{self.auth_app}"}
        payload = {
            "nlPatientId": "ALICEx1",
            "gender": gender,
    ...
    def check_invalid_gender(self, gender):
        headers = {"Authorization-App": f"{self.auth_app}"}
        payload = {
            "nlPatientId": "ALICEx1",
            "gender": gender,
    ...
    def request_missing_birthdate(self):
        headers = {"Authorization-App": f"{self.auth_app}"}
        payload = {
            "nlPatientId": "ALICEx1",
            "gender": "male"
    ...
    def valid_birthdate_check(self, birthdate):
        headers = {"Authorization-App": f"{self.auth_app}"}
        payload = {
            "nlPatientId": "ALICEx1",
            "gender": "male",
    ...
    def validate_birth_year(self, birthdate):
        headers = {"Authorization-App": f"{self.auth_app}"}
        payload = {
            "nlPatientId": "ALICEx1",
            "gender": "male",
